...
public class MyLogger{
    ...
    /*DEBUG_VALUE=4 [Print to stdout everytime a constructor is called]
      ...
      DEBUG_VALUE=2 [Print the operation performed by the states before saving it to Result]
      DEBUG_VALUE=1 [Print the operations saved in Result before writing to output file]
